...
export const backgroundsData = [artist,noble,sailor,sage,acolyte,criminal,artisan,soldier,merchant,charlatan,urchin,folkhero,outlander,gambler,plaintiff,scion,rivalintern,giantfoundling,scion];