...
export const tiefling: Species = {
    ...
    variants: [
      ...
      },
      {
        ...
        {
          title: 'Происхождение исчадия (таблица)',
          description: 'Наследие\tУровень 1\tУровень 3\tУровень 5\nЛевистус\tУ вас есть сопротивление к урону Холоду. Вы также знаете заговор Луч холода.\tДоспех Агатиса\tТьма'
        }
      ],
      replacesAbilities: ['Происхождение исчадия (таблица)']
      },
      ...
      },
      {
        ...
        abilities: [
        {
          ...
          description: 'У вас есть сопротивление к урону Огнём.'
        },
        {
          title: 'Крылатый',
