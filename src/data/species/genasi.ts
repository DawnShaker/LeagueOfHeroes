...
export const genasi: Species = {
  ...
  abilities: [
    ...
    {
      title: 'Возраст',
      description: 'Дженази взрослеют приблизительно с той же скоростью, как и люди, и достигают зрелости в позднем подростковом возрасте. Они живут несколько дольше людей — 120 лет.'
    },
    {
      title: 'Тёмное зрение',
    ...
    {
      title: 'Вариант',
      description: 'Выберите подвид дженази'
    }
  ],
    variants: [
      {
        ...
        },
        {
          ...
          description: 'Пока вы не Недееспособны, вы можете задерживать дыхание на неопределённое время.'
        },
        {
      ...
      replacesAbilities: ['Тёмное зрение', 'Тёмное зрение', 'Тёмное зрение', 'Тёмное зрение', 'Тёмное зрение', 'Вариант']
    },
        {
        name: 'Дженази Земли',
        nameEn: 'Earth Genasi',
      ...
      replacesAbilities: ['Тёмное зрение', 'Тёмное зрение', 'Тёмное зрение', 'Вариант']
      },
        {
        name: 'Дженази Огня',
        nameEn: 'Fire Genasi',
