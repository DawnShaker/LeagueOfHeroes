...
export const autognome: Species = {
  ...
  abilities: [
    ...
    },
    {
      ...
      description: 'Вы получаете сопротивление урону ядом и иммунитет к болезням, а также с Преимуществом совершаете спасброски против состояний Парализованный или Отравленный. Вам не нужно есть, пить или дышать.'
    },
    {
      title: 'Создан для успеха',
      description: 'Вы можете добавить д4 к одному броску атаки, проверке характеристики или спасброску, который вы совершаете. Вы можете совершить это уже после броска к20, но должны сделать это прежде, чем Мастер объявит результат броска. Вы можете использовать эту особенность количество раз, равное вашему Бонусу мастерства. Вы восстанавливаете все израсходованные использования после окончания Продолжительного отдыха.'
    },
    {
      title: 'Отдых стража',
    ...
    },
    {
      ...
      description: 'Если на вас накладывают заклинание Починка, вы можете потратить Кость Хитов, бросить её и восстановить количество Хитов, равное результату броска + ваш модификатор Телосложения (минимум 1 хит).\nКроме того, ваш создатель разработал вас так, чтобы вы получали преимущества от заклинаний сохраняющих жизнь, но которые обычно не действуют на Конструктов: Лечение ран, Лечащее слово, Множественное лечение ран, Множественное лечащее слово и Уход за умирающим.'
    }
  ]
};