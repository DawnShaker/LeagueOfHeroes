...
export const tabaxi: Species = {
  ...
  abilities: [
    ...
    {
      title: 'Кошачьи когти',
      description: 'Вы можете использовать ваши когти для совершения безоружных ударов. Когда вы попадаете атакой ими, удар наносит 1к6 + ваш модификатор Силы Рубящего урона.'
    },
    {
