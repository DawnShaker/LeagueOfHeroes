...
export const minotaur: Species = {
  ...
  abilities: [
    ...
    {
      title: 'Рога',
      description: 'У вас есть рога, которое вы можете использовать для совершения безоружных ударов. Когда вы атакуете ими, вы наносите 1к6 + ваш модификатор Силы Колющего урона.'
    },
    {
