...
export const minotaur: Species = {
  ...
  abilities: [
    ...
    {
      title: 'Рога',
      description: 'У вас есть рога, которое вы можете использовать для совершения Безоружных ударов. Когда вы атакуете ими, вы наносите 1д6 + ваш модификатор Силы Колющего урона.'
    },
    {
      title: 'Пронзающий натиск',
      description: 'Сразу после того, как в свой ход вы совершите действие Рывок и переместитесь по крайней мере на 20 футов, вы можете Бонусным действием совершить одну атаку вашими Рогами.'
    },
    {
