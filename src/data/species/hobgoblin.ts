...
export const hobgoblin: Species = {
  ...
  abilities: [
    {
      title: 'Возраст',
      description: 'Хобгоблины взрослеют с той же скоростью, что и люди, и имеют примерно такую же продолжительность жизни.'
    },
    {
      title: 'Тёмное зрение',
    ...
    {
      title: '',
      description: '• Радушие. Вы и существо, которому вы помогаете, получаете количество Временных хитов, равное 1к6 + ваш Бонус мастерства.\n\n• Проход. У вас и существа, которому вы помогаете, увеличивается скорость ходьбы на 10 футов до начала вашего следующего хода. \n\n• Злость. До начала вашего следующего хода, когда атака существа, которому вы помогаете, впервые попадает по цели броском атаки, эта цель получает Помеху на следующий бросок атаки, который она совершает в течение следующей минуты.'
    },
    {
