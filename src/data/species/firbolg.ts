...
export const firbolg: Species = {
  ...
  abilities: [
    ...
    },
    {
      ...
      description: 'Вы можете накладывать заклинания Обнаружение магии и Маскировка с помощью этой особенности. Когда вы накладываете эту версию заклинания Маскировка, вы можете казаться на 3 фута ниже или выше, чем обычно. После накладывания одного из этих заклинаний с помощью особенности вы должны закончить Продолжительный отдых, прежде чем сможете вновь наложить его таким образом. Вы также можете накладывать эти заклинания, используя ячейки заклинаний подходящего уровня.\nИнтеллект, Мудрость или Харизма является вашей базовой характеристикой для этих заклинаний (выберите одну из них при выборе этой расы).'
    },
    {
