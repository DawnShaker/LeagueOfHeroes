...
export const hadozee: Species = {
  ...
  abilities: [
    ...
    },
    {
      ...
      description: 'Магия, которая течёт в ваших венах, усиливает вашу естественную защиту. Когда вы получаете урон, вы можете реакцией бросить д6. Добавьте свой Бонус мастерства к выпавшему числу и уменьшите получаемый вами урон на величину, равную этой сумме (минимум 0 урона).\nВы можете использовать эту особенность количество раз, равное вашему Бонусу мастерства. Вы восстанавливаете все потраченные использования, когда заканчиваете Продолжительный отдых.'
    }
  ]
};