...
export const simichybrid: Species = {
  id: 'simichybrid',
  name: 'Гибрид симиков',
  nameEn: 'Simic hybrid',
  sourceBook: 'GGR14',
  ...
  portrait: '/images/species/simichybrid.jpg',
  type: 'Гуманоид',
  size: 'Средний',
  speed: 30,
  abilities: [
