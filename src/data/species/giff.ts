...
export const giff: Species = {
  ...
  abilities: [
    {
      title: 'Возраст',
      description: 'Гиффы достигают физической зрелости в 15 лет и считаются взрослыми в обществе Гиффов, когда получают звание рядового. Максимальный средний возраст достигает 80 лет, но смерть от старости считается признаком того, что человек не был «достаточно авантюрным».'
    },
    {
