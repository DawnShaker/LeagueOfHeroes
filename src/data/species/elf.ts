...
export const elf: Species = {
  ...
  variants: [
    ...
    },
    {
      ...
      abilities: [
        ...
        {
          title: 'Транс',
          description: 'Вам не нужно спать, и вас невозможно магически усыпить. Вы можете закончить Продолжительный отдых за 4 часа, если проводите это время в медитации, подобной трансу, во время которой сохраняете сознание.\nВсякий раз, когда вы заканчиваете этот транс, вы можете получить два владения, которых у вас нет. Каждое из них должно быть владением оружием или инструментом по вашему выбору из «Книги игрока». Вы сохраняете эти владения до окончания следующего Продолжительного отдыха.'
        }
      ],
      replacesAbilities: ['Происхождения эльфов', 'Происхождения эльфов (таблица)', 'Транс']
    },
    {
      ...
      abilities: [
        ...
        },
        {
          ...
          description: 'Вы получаете сопротивление урону Некротикой.'
        },
        {
          title: 'Транс',
  ...
  abilities: [
    ...
    },
    {
      ...
      description: 'Вы получаете владение 1 навыком на выбор из списка: Проницательность, Восприятие или Выживание.'
    },
    {
      title: 'Транс',
