...
export const satyr: Species = {
  ...
  abilities: [
    ...
    {
      title: 'Таран',
      description: 'Вы можете использовать свою голову и рога, для нанесения Безоружных ударов. Когда вы атакуете ими, вы наносите 1к6 + ваш модификатор Силы Дробящего урона.'
    },
    {
    ...
    },
    {
      ...
      description: 'Каждый раз, когда вы совершаете прыжок в длину или высоту, вы можете бросить д8 и прибавить выпавшее число к количеству футов, которое вы можете преодолеть прыжком, даже если прыгаете с места. Это дополнительное расстояние стоит передвижение, как и обычное.'
    },
    {
      title: 'Гуляка',
