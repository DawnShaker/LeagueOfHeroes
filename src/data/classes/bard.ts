      ...
      features: [
        {
          ...
          level: 3,
          description: 'При вступлении в коллегию шёпотов вы получаете возможность сделать свою атаку оружием магически токсичной для разума существа. Когда вы попадаете по существу атакой оружием, вы можете потратить одно "Вдохновение барда" и нанести цели дополнительные 2д6 урона психической энергией. Вы можете использовать это умение один раз за раунд в свой ход.\nУрон психической энергией увеличивается, когда вы получаете определенный уровень в этом классе, увеличиваясь до 3д6 на 5-м уровне, 5д6 на 10-м уровне и 8д6 на 15-м уровне.'
        },
        {
          name: 'Слово ужаса',
          level: 3,
      ...
      features: [
        ...
        },
        {
          ...
          collapsible: [
            {
              title: 'Истории духов',
              description: 'Истории духов',
              tableData: {
                headers: ['Кость бардовского вдохновения', 'История, рассказанная через вас'],
                rows: [
                  ['1', 'История об умном животном. В течение следующих 10 минут каждый раз, когда цель совершает проверку Интеллекта, Мудрости или Харизмы, она может бросить дополнительную кость сразу после броска д20 и добавить выпавшее число на дополнительной кости к общему результату проверки. Тип дополнительной кости — тот же, что и у вашей кости бардовского вдохновения.'],
                  ...
                  ['11', 'История об ангеле. Цель восстанавливает хиты, равные двум броскам вашей кости бардовского вдохновения + модификатор Харизмы, и вы заканчиваете одно из следующих состояний цели: Оглохший, Окамененевший, Отравленный, Парализованный или Ослеплённый.'],
