...
export const artificer: Class = {
  ...
  features: [
    ...
    {
      name: 'Создание дополнительных магических предметов',
      level: 2,
      description: '',
      collapsible: [
        {
    ...
    {
      name: 'Схемы магических предметов (2+ уровень Артефактора)',
      level: 2,
      description: '—',
      collapsible: [
        {
          title: 'Схемы магических предметов',
    ...
    {
      name: 'Схемы магических предметов (6+ уровень Артефактора)',
      level: 2,
      description: '—',
      collapsible: [
        {
    ...
    {
      name: 'Схемы магических предметов (10+ уровень Артефактора)',
      level: 2,
      description: '—',
      collapsible: [
        {
    ...
    {
      name: 'Схемы магических предметов (14+ уровень Артефактора)',
      level: 2,
      description: '—',
      collapsible: [
        {
